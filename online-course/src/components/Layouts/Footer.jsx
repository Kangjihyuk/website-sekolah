import LinkFooter from "../Fragments/LinkFooter";
...
const Footer = () => {
  return (
    <>
      <footer className=" dark:bg-gray-900 mt-10 lg:mt-32 bg-primary/50 ">
        <div className="mx-auto w-full max-w-screen-xl container">
          <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
            {TitleFotter.map((item) => {
              return (
                <LinkFooter
                  key={item.id}
                  title={item.title}
        ...
        <div className="sm:flex sm:items-center sm:justify-between container pb-4">
